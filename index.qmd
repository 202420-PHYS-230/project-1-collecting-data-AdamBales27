...
We measured the voltage at two points in a resistor network to validate the behavior of the circuit. We found the ratio of voltages was: $0.6646\pm 0.001$ close to the expected value of $0.667$. We also measured the decay over time of the voltage on a capacitor. We used that to estimate the decay time constant and found that to be $\tau = 67.33 \pm 0.354\mathrm{~ms}$, very close to the expected value of $\tau =66.646\mathrm{~ms}$.
